...
<head>
    ...
    <title>MUSE | CONTACT</title>
		<link rel="icon" type="image/x-icon" href="images/muselogo.png">
	 ...
	 <!-- Import the web page's style sheet -->
		...
		<link rel="stylesheet" href="css/contact_v3.css">
...
<body>
	...
	<nav class="navbar">
		<ul class="nav-links">
			...
			<li><a href="page3_v5.html">PRODUCTS</a></li>
			<li><a href="page5_v3.html">PRE-ORDER</a></li>
			<li><a href="page6_v3.php">CONTACT</a></li>
		</ul>
		...
		<div class="container">
			<div class="form">
				<div class="contact-info">
					...
					<p class="text">
						Please feel free to contact us about any questions, queries or concerns.
					</p><!--information/blurb-->
					<div class="info">
						<div class="information">
							<img src="images/location.svg" class="icon" alt="icon 1"><!--location-->
							<p>Wellington, NZ</p>
						</div>
						<div class="information">
							<img src="images/mail.svg" class="icon" alt="icon 2"><!--MUSE college email-->
							<p>muse_cosmetics@gmail.com</p>
						</div>
						<div class="information">
							<img src="images/phone.svg" class="icon" alt="icon 3"><!--MUSE college number-->
							<p>020 142 02938</p>
						</div>
					</div>
				</div>
	...
	<div class="footer-content">
		...
		<div class="footer-content">
			...
			<p class="copyright">Copyright © MUSE 2026<br> All Rights Reserved</p>
		</div>
